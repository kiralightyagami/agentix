...
export const SkeletonFour = () => {
  const items = [
    ...
    },
    {
      ...
      className:
        "bg-green-100 border border-blue-200 dark:bg-neutral-800 dark:border-neutral-700",
      description:
    ...
    },
    {
      ...
      className:
        "bg-indigo-100 border border-blue-200 dark:bg-neutral-800 dark:border-neutral-700",
      description:
    ...
    },
    {
      ...
      className:
        "bg-neutral-100 border border-blue-200 dark:bg-neutral-800 dark:border-neutral-700",
      description:
    ...
    },
    {
      ...
      className:
        "bg-purple-100 border border-blue-200 dark:bg-neutral-800 dark:border-neutral-700",
      description:
        "Automatically trigger approvals based on predefined criteria, ensuring timely review and compliance.",
      tags: [
        { text: "Salesforce", icon: <SalesForceIcon /> },
      ...
      <div className="flex gap-4 items-center justify-center max-w-lg mx-auto flex-wrap mb-4">
        {items.map((item, idx) => (
          <button
            ...
            className={cn(
              "text-sm opacity-50 relative active:scale-98 transition duration-200 cursor-pointer flex gap-1 items-center justify-center px-2 py-1 rounded-sm",
...
const Card = ({
  ...
  return (
    <motion.div
      key={title}
      className="flex-col p-4 gap-4 shadow-black/10 bg-white dark:bg-neutral-800 border border-transparent ring-1 rounded-[16px] ring-black/10 dark:ring-white/10 flex items-start"
    >
